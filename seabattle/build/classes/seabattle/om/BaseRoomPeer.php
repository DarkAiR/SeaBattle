...
abstract class BaseRoomPeer {
	...
	const TIME_STAMP = 'room.TIME_STAMP';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'State', 'TimeStamp', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'state', 'timeStamp', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::STATE, self::TIME_STAMP, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'STATE', 'TIME_STAMP', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'state', 'time_stamp', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'State' => 1, 'TimeStamp' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'state' => 1, 'timeStamp' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::STATE => 1, self::TIME_STAMP => 2, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'STATE' => 1, 'TIME_STAMP' => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'state' => 1, 'time_stamp' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(RoomPeer::STATE);
			$criteria->addSelectColumn(RoomPeer::TIME_STAMP);
		} else {
	...
	/**
	 * Method to invalidate the instance pool of all tables related to room
	...
	{
		$key = RoomPeer::getPrimaryKeyHashFromRow($row, $startcol);
		if (null !== ($obj = RoomPeer::getInstanceFromPool($key))) {
			// We no longer rehydrate the object, since this can cause data loss.
			// See http://www.propelorm.org/ticket/509
			// $obj->hydrate($row, $startcol, true); // rehydrate
			$col = $startcol + RoomPeer::NUM_HYDRATE_COLUMNS;
		} else {
			$cls = RoomPeer::OM_CLASS;
			$obj = new $cls();
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseRoomPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseRoomPeer::TABLE_NAME))
	  {
	...
	/**
	 * Performs an UPDATE on the database, given a Room or Criteria object.
	 *
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(RoomPeer::ID);
			if ($value) {
				$selectCriteria->add(RoomPeer::ID, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(RoomPeer::TABLE_NAME);
			}
	...
	public static function doValidate($obj, $cols = null)
	{
		...
		return BasePeer::doValidate(RoomPeer::DATABASE_NAME, RoomPeer::TABLE_NAME, $columns);
	}
