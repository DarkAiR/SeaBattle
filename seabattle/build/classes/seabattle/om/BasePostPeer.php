...
abstract class BasePostPeer {
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Text', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'text', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::TEXT, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USER_ID', 'TEXT', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'text', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Text' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'text' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::TEXT => 2, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USER_ID' => 1, 'TEXT' => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'text' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
