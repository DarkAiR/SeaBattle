...
abstract class BaseField extends BaseObject  implements Persistent
{
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = FieldPeer::USER_ID;
		}
	...
	public function setData($v)
	{
		...
		if ($this->data !== $v) {
			$this->data = $v;
			$this->modifiedColumns[] = FieldPeer::DATA;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = FieldPeer::NUM_HYDRATE_COLUMNS.
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(FieldPeer::ID)) {
			$modifiedColumns[':p' . $index++]  = '`ID`';
		}
		if ($this->isColumnModified(FieldPeer::USER_ID)) {
			$modifiedColumns[':p' . $index++]  = '`USER_ID`';
		}
		if ($this->isColumnModified(FieldPeer::DATA)) {
			$modifiedColumns[':p' . $index++]  = '`DATA`';
		}

		$sql = sprintf(
			'INSERT INTO `field` (%s) VALUES (%s)',
	...
	{
		if (isset($alreadyDumpedObjects['Field'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Field'][$this->getPrimaryKey()] = true;
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FieldPeer::USER_ID)) $criteria->add(FieldPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(FieldPeer::DATA)) $criteria->add(FieldPeer::DATA, $this->data);
	...
	{
		return (string) $this->exportTo(FieldPeer::DEFAULT_STRING_FORMAT);
	}
